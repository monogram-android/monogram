...
internal class TelegramBackendStreamingRouter(
    ...
    private val mtProtoFactory: () -> MtProtoStreamingRepository = { throw UnsupportedOperationException("MTProto streaming is not configured") },
    ...
    override fun getDownloadProgress(fileId: Int): Flow<Float> = when (selected()) {
        ...
        TelegramBackendKind.KOTLIN_MTPROTO -> mtProto.getDownloadProgress(fileId)
    }
