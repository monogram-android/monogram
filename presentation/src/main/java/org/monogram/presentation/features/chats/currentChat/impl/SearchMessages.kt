...
private fun DefaultChatComponent.hasSearchCriteria(state: org.monogram.presentation.features.chats.currentChat.ChatComponent.State): Boolean {
...
private fun DefaultChatComponent.hasMoreSearchResults(state: org.monogram.presentation.features.chats.currentChat.ChatComponent.State): Boolean {
